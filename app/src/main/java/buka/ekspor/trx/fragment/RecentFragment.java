...
//        }
        ...
        eksporList.add(UtilBuEks.getPreparedData().get(0));
        eksporList.add(UtilBuEks.getPreparedData().get(1));
        eksporList.add(UtilBuEks.getPreparedData().get(2));
        eksporList.add(UtilBuEks.getPreparedData().get(3));
